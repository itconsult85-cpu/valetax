            ...
            <div class="container-fluid">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
                    <div>
                        ...
                        <p class="text-secondary mb-0">Daftar pengguna yang telah mencapai progress pendaftaran terakhir.</p>
                    </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card border-0 shadow-sm h-100"><div class="card-body"><div class="text-secondary small">Total anggota</div><div class="fs-2 fw-semibold mt-1"><?= number_format($total, 0, ',', '.') ?></div><div class="text-success small mt-2"><i class="bi bi-check-circle me-1"></i>Progress 6 atau lebih</div></div></div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                <?php if ($users === []): ?>
                                    <tr><td colspan="8" class="text-center text-secondary py-5"><i class="bi bi-inbox fs-2 d-block mb-2"></i>Belum ada anggota yang mencapai progress 6.</td></tr>
                                <?php else: ?>
                    ...
                    <div class="card-footer bg-white border-0 text-secondary small"><i class="bi bi-info-circle me-1"></i>Data hanya menampilkan pengguna dengan <strong>current_step &ge; 6</strong>.</div>
                </div>
            </div>
        </div>
    </main>
