...
<div class="row g-3 mb-4">
    ...
    <div class="col-sm-6 col-xl-3"><div class="card border-0 shadow-sm h-100"><div class="card-body"><div class="text-secondary small">Tampilan data</div><div class="fs-5 fw-semibold mt-2">Client-side</div><div class="text-secondary small mt-2">Pencarian dan pagination cepat di browser</div></div></div></div>
</div>

<div class="card border-0 shadow-sm" id="joined-users-table-wrapper" data-url="<?= site_url('JoinedUsers/data') ?>">
    <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center"><h2 class="h6 mb-0 fw-semibold"><i class="bi bi-table me-2 text-primary"></i>Datasheet anggota</h2><span class="badge text-bg-light">DataTable</span></div>
    <div class="card-body">
