...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/dashboard-data.css?v=20260919-4') ?>">
</head>
...
<div class="app-wrapper">
    <nav class="app-header navbar navbar-expand bg-body">
        <div class="container-fluid">
            ...
            <div class="ms-auto d-flex align-items-center gap-3"><span class="text-secondary small d-none d-md-inline"><i class="bi bi-person-circle me-1"></i><?= esc(session()->get('username') ?? '') ?></span><a class="btn btn-sm btn-outline-danger" href="<?= site_url('auth/logout') ?>"><i class="bi bi-box-arrow-right me-1"></i>Keluar</a></div>
        </div>
    </nav>
    <?= $this->include('layouts/adminlte_sidebar') ?>
    <main class="app-main"><div class="app-content p-3 p-md-4"><div class="container-fluid">
